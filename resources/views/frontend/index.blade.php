                    ...
                    <div class="bg-gradient-to-l from-secondary to-background rounded-2xl p-5">
                        <div
                            ...
                            <div class="flex-shrink-0 flex justify-center md:w-72 w-full md:order-2 -order-1">
                                <img src="{{asset('images/theme/intro/main.png')}}" class="max-w-full" alt="..." />
                            </div>
                        </div>
                    </div>
                    <!-- end intro -->
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="{{asset('images/courses/01.jpg')}}" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="{{asset('images/courses/02.jpg')}}" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                            <a href="./course-category.html"
                                                class="absolute left-3 top-3 h-11 inline-flex items-center justify-center gap-1 bg-black/20 rounded-full text-white transition-all hover:opacity-80 px-4">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="{{asset('images/courses/03.jpg')}}" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                            <a href="./course-category.html"
                                                class="absolute left-3 top-3 h-11 inline-flex items-center justify-center gap-1 bg-black/20 rounded-full text-white transition-all hover:opacity-80 px-4">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="{{asset('images/courses/04.jpg')}}" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                            <a href="./course-category.html"
                                                class="absolute left-3 top-3 h-11 inline-flex items-center justify-center gap-1 bg-black/20 rounded-full text-white transition-all hover:opacity-80 px-4">
                            ...
                            <div class="grid sm:grid-cols-2 grid-cols-1 gap-x-5 gap-y-8 space-y-8">
                                <div class="space-y-5">
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="{{asset('images/courses/01.jpg')}}" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="{{asset('images/courses/02.jpg')}}" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                                class="absolute left-3 -bottom-3 w-9 h-9 inline-flex items-center justify-center bg-secondary rounded-full shadow-xl text-muted transition-colors hover:text-red-500 z-10">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="{{asset('images/courses/03.jpg')}}" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                                class="absolute left-3 -bottom-3 w-9 h-9 inline-flex items-center justify-center bg-secondary rounded-full shadow-xl text-muted transition-colors hover:text-red-500 z-10">
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="{{asset('images/courses/04.jpg')}}" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                                class="absolute left-3 -bottom-3 w-9 h-9 inline-flex items-center justify-center bg-secondary rounded-full shadow-xl text-muted transition-colors hover:text-red-500 z-10">
