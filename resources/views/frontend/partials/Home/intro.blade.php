                            ...
                            <div class="space-y-10">
                                <div class="space-y-5">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3">
                                        <a href="{{ route('contact.index') }}" class="inline-flex items-center justify-center gap-1 h-11 bg-primary rounded-full text-primary-foreground transition-all hover:opacity-80 px-4">
                                            <span class="whitespace-nowrap font-semibold text-sm">ثبت درخواست پروژه</span>
                                        ...
                                        <a href="{{ route('contact.index') }}" class="inline-flex items-center justify-center gap-1 h-11 bg-foreground rounded-full text-background transition-all hover:opacity-80 px-4">
