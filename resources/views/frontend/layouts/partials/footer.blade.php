                    ...
                    <div class="md:w-5/12 w-full">
                        <div class="bg-secondary rounded-3xl space-y-5 p-8">
                            ...
                            <p class="font-semibold text-sm text-muted">
                                آرش فدایی هستم
                                توسعه‌دهنده PHP و لاراول با ۵+ سال سابقه در طراحی اسکریپت‌های اختصاصی، بهینه‌سازی سئو و سرعت، مدیریت فروشگاه‌های آنلاین (e-commerce)، پلاگین‌نویسی ووکامرس و سیستم‌های اتوماسیون پیچیده. همراه تیم‌های پویا برای چالش‌های نوآورانه.
