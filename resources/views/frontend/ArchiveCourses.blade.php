                                ...
                                <div class="relative">
                                    <div class="relative z-10">
                                        ...
                                        <div
                                            ...
                                            <span class="font-semibold text-sm">{{$course->course_categorie->name}}</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="space-y-3 p-5">
                                            <div class="flex flex-wrap items-center gap-3">
                                                <div class="flex items-center gap-1 text-muted">
                                                    ...
                                                    <span class="font-semibold text-xs">{{$course->lessons_count}} درس</span>
                                                </div>
                                                ...
                                                <div class="flex items-center gap-1 text-muted">
                                                    ...
                                                    <span class="font-semibold text-xs">{{$course->time_course}} ساعت</span>
                                                </div>
                                            </div>
