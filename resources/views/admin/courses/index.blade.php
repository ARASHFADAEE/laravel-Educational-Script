    ...
    <header>
        ...
        <table class="min-w-full table-auto">
            ...
            <tbody class=" text-white divide-y divide-gray-200">
                ...
                <tr class=" transition">
                    <td class="px-6 py-4 text-sm text-white">{{ $course->id }}</td>
                    <td class="px-6 py-4 text-sm text-white">{{ $course->title }}</td>
                    <td class="px-6 py-4 text-sm text-white">{{ $course->slug }}</td>
                    ...
                    <td class="px-6 py-4 text-sm font-medium text-center space-x-2 space-x-reverse flex items-center gap-3 ">
                        <!-- دکمه ویرایش -->
                        <a href="{{ route('admin.courses.edit', $course->id) }}" class="text-indigo-600  items-center">
