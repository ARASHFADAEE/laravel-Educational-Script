        ...
        <div class="p-6">
            ...
            <nav class="space-y-1">
                ...
                <div class="pt-2">
                    ...
                    <a href="{{ route('admin.subscription-settings.index') }}" class="mt-1 flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('admin.subscription-settings.*') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800' }} transition-all group">
                        <svg class="w-5 h-5 {{ request()->routeIs('admin.subscription-settings.*') ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="font-medium">تنظیمات اشتراک</span>
                    </a>
                    <a href="{{ route('admin.subscription-plans.index') }}" class="mt-1 flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('admin.subscription-plans.*') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800' }} transition-all group">
                        <svg class="w-5 h-5 {{ request()->routeIs('admin.subscription-plans.*') ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                        </svg>
