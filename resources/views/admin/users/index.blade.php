...
<div class="overflow-x-auto bg-white shadow-lg rounded-lg">
    <header>
        <div class="from-gray-900  px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        ...
        <table class="min-w-full table-auto">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900">{{$user->created_at}}</td>
                    <td class="px-6 py-4 text-sm font-medium text-center space-x-2 space-x-reverse flex items-center gap-3 ">
                        <!-- دکمه ویرایش -->
                        <a href="{{ route('admin.users.edit', $user->id) }}" class="text-indigo-600 hover:text-indigo-900  items-center">
