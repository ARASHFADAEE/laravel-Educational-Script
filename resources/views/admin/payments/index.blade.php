...
<div class="overflow-x-auto  shadow-lg rounded-lg">
    <header>
        <div class="from-gray-900  px-6 py-4 border-b flex items-center justify-between">
            ...
            <a href="" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg shadow-sm inline-flex items-center">
                ...
                <tr class=" transition">
                    ...
                    <td class="px-6 py-4 text-sm">
                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-900 text-white">
                            {{ $payment->status == 'published' ? 'منتشر شده' : 'پیش نویس' }}
                        </span>
                    </td>
