                    ...
                    <tr class=" transition">
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            @switch($payment->status)
                                @case('pending')
                                    <span
                                        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-800 text-black">
                                ...
                                @case('completed')
                                    <span
                                        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-800 text-white">
                                        <span>تکمیل شده </span>
                                    </span>
                                @break
