...
<div class="overflow-x-auto  shadow-lg rounded-lg">
    <header>
        <div class="from-gray-900  px-6 py-4 border-b flex items-center justify-between">
            ...
            <a href="{{route('admin.course_categories.create')}}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg shadow-sm inline-flex items-center">
            ...
            <tbody class=" text-white divide-y divide-gray-200">
                ...
                <tr class=" transition">
                    ...
                    <td class="px-6 py-4 text-sm font-medium text-center space-x-2 space-x-reverse flex items-center gap-3 ">
                        ...
                        <!-- دکمه حذف -->
                        <form action="{{route('admin.course_categories.destroy', $category->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
